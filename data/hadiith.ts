export const hadiithCollection = {
  niyyah: [
    {
      ...
      topic: "Niyyah",
      keywords: ["niyyah", "absicht", "absichten", "taten"],
      arabic: "إِنَّمَا الْأَعْمَالُ بِالنِّيَّاتِ",
      transliteration: "Innamal-a‘maalu bin-niyyaat",
      translation: "Die Taten werden nur nach den Absichten beurteilt.",
  ...
  bidaah: [
    {
      ...
      number: "5",
      primarySources: ["Sahih al-Buchari", "Sahih Muslim"],
      topic: "Zurückweisung von Neuerungen",
      keywords: ["bidaah", "neuerung", "neuerungen", "zurückweisung"],
      translation:
  ...
  naseehah: [
    {
      ...
      primarySources: ["Sahih Muslim"],
      topic: "Naseehah",
      keywords: ["naseehah", "rat", "aufrichtiger rat", "religion"],
      translation: "Die Religion ist Naseehah.",
      authenticity: "Sahih Muslim",
      text: "Die Religion ist Naseehah.",
    },
  ],
  ...
  verbote: [
    {
      ...
      number: "9",
      primarySources: ["Sahih al-Buchari", "Sahih Muslim"],
      topic: "Verbote und Pflichten",
      keywords: ["verbot", "verbote", "pflicht", "pflichten", "gebote"],
      translation:
  ...
  annahme: [
    {
      ...
      number: "10",
      primarySources: ["Sahih Muslim"],
      topic: "ALLAAH ist gut und nimmt nur Gutes an",
      keywords: ["annahme", "duaa", "du'aa", "rein", "reinheit", "gut"],
      translation: "ALLAAH ist gut und nimmt nur Gutes an.",
      authenticity: "Sahih Muslim",
      text: "ALLAAH ist gut und nimmt nur Gutes an.",
    },
  ],
